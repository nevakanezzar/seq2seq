export VOCAB_SOURCE=${HOME}/stuff/project/data/exp-data/s2s/train/all/vocab.trimmed.fce.nonumbers.txt
export VOCAB_TARGET=${HOME}/stuff/project/data/exp-data/s2s/train/all/vocab.trimmed.fce.nonumbers.txt
