...
export MODEL_DIR=/cluster/project2/mr/skasewa/models/new_corruption6
mkdir -p $MODEL_DIR

python3 -m bin.train \
  --config_paths="./example_configs/new_corruption_model6.yml,
