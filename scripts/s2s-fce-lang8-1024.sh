export VOCAB_SOURCE=${HOME}/stuff/project/data/exp-data/s2s/train/fce-lang8/vocab.combined.txt
export VOCAB_TARGET=${HOME}/stuff/project/data/exp-data/s2s/train/fce-lang8/vocab.combined.txt
...
export MODEL_DIR=/cluster/project2/mr/skasewa/models/1024-s2s-fce-lang8
mkdir -p $MODEL_DIR

python3 -m bin.train \
  --config_paths="./example_configs/s2s-1024-model.yml,
