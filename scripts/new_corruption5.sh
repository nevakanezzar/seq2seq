export VOCAB_SOURCE=${HOME}/stuff/project/data/parsed_fce/train/combined.vocab.txt
export VOCAB_TARGET=${HOME}/stuff/project/data/parsed_fce/train/combined.vocab.txt
...
export MODEL_DIR=/cluster/project2/mr/skasewa/models/new_corruption5
mkdir -p $MODEL_DIR

python3 -m bin.train \
  --config_paths="./example_configs/new_corruption_model5.yml,
