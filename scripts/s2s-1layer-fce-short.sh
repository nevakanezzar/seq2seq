export VOCAB_SOURCE=${HOME}/stuff/project/data/exp-data/s2s/train/fce/vocab.combined.shortened.txt
export VOCAB_TARGET=${HOME}/stuff/project/data/exp-data/s2s/train/fce/vocab.combined.shortened.txt
...
export MODEL_DIR=/cluster/project2/mr/skasewa/models/1layer-fce-short
mkdir -p $MODEL_DIR
