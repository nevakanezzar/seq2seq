export VOCAB_SOURCE=${HOME}/stuff/project/data/exp-data/s2s/train/fce/vocab.char.combined.txt
export VOCAB_TARGET=${HOME}/stuff/project/data/exp-data/s2s/train/fce/vocab.char.combined.txt
...
export MODEL_DIR=/cluster/project2/mr/skasewa/models/char-fce
mkdir -p $MODEL_DIR

python3 -m bin.train \
  --config_paths="./example_configs/s2s-fce-model.yml,
                  ./example_configs/char-fce-train.yml,
